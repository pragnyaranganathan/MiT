...
public class IabHelper {
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            com.epochconsulting.motoinventory.vehicletracker.util.Purchase purchase ;
            try {
                purchase = new com.epochconsulting.motoinventory.vehicletracker.util.Purchase(mPurchasingItemType, purchaseData, dataSignature);
     ...
     */
    void consume(com.epochconsulting.motoinventory.vehicletracker.util.Purchase itemInfo) throws IabException {
        checkNotDisposed();
        ...
        do {
            ...
            for (int i = 0; i < purchaseDataList.size(); ++i) {
                ...
                if (Security.verifyPurchase(mSignatureBase64, purchaseData, signature)) {
                    ...
                    com.epochconsulting.motoinventory.vehicletracker.util.Purchase purchase = new com.epochconsulting.motoinventory.vehicletracker.util.Purchase(itemType, purchaseData, signature);
    ...
    void consumeAsyncInternal(final List<com.epochconsulting.motoinventory.vehicletracker.util.Purchase> purchases,
        ...
        (new Thread(new Runnable() {
            public void run() {
                ...
                for (com.epochconsulting.motoinventory.vehicletracker.util.Purchase purchase : purchases) {
                    try {
                        consume(purchase);
